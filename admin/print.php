...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>COMFORT ZONE HOTEL,</p>
				<p>Mohali,<br>Punjab,<br>India.</p>
				<p>(+91) 8833667721</p>
			</address>
			<span><img alt="" src="assets/img/comfort.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@COMFORTZONE.com || Web :- www.comfortzone.com || Phone :- +91 8833667721 </p>
			</div>
		</aside>
	</body>
</html>
